...
class VenueDetailsSixTBVCell: UITableViewCell {

    @IBOutlet weak var collectionView: UICollectionView!
    var albumDecorData = WeddingDecorData.getFamouesDecorData()
...
extension VenueDetailsSixTBVCell: UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        categoryCell.lblTime.isHidden = true
        return categoryCell
    }
